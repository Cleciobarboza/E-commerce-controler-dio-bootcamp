...
@Service
public class ProductChangeAvailabilityProductImpl implements IProductChangeAvailabilityProducer {

    private final RabbitTemplate rabbitTemplate;
    private final String exchangeName;
    private final String routingKeyName;

    public ProductChangeAvailabilityProductImpl(final RabbitTemplate rabbitTemplate,
